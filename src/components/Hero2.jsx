        ...
        <div className="relative px-6 lg:px-8">
          <div className="mx-auto max-w-3xl pt-20 pb-32 sm:pt-24 sm:pb-40">
            <div>
              ...
              <div>
                <h1 className="text-4xl font-bold font-display  tracking-tight sm:text-center sm:text-6xl   ransition delay-150 duration-300 ease-in-out hover:-translate-y-1  hover:scale-110">
                GESTION REGULATORIA
                </h1>
                <h2 className='bg-gradient-to-r from-red-300 to-red-900 bg-clip-text text-transparent text-3xl text-center'>
